...
# metadata
metadata = {
    'protocolName': 'Induction for 4 Conditions',
    'author': 'Trevor Y. H. Ho <trevor.ho@ed.ac.uk>',
    'description': 'Transfer bacteria from overnight culture to new culture \
        of 4 different conditions for induction.',
    'apiLevel': '2.7'
}
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    def distributeNoBlowOutLite(pipette, vol_in, vol_out, source, dests, waste):
        pipette.pick_up_tip()
    ...
    for i in range(12):
        distributeNoBlowOutLite(l_pipette,
                                6,
                                2,
